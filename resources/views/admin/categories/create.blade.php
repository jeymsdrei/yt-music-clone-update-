...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-white/60 mt-1">Add a new category</p>
        </div>
    </div>
    ...
    <div class="glass-card rounded-xl p-6">
        <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" class="input-field @error('name') border-red-500 @enderror" required oninput="generateSlug(this.value)">
                @error('name')
            ...
            <div>
                ...
                <input type="text" name="slug" id="slug" value="{{ old('slug') }}" class="input-field @error('slug') border-red-500 @enderror">
            ...
            <div>
                ...
                <div class="relative border-2 border-dashed border-white/10 rounded-xl p-6 text-center hover:border-red-500/50 transition-colors cursor-pointer" onclick="document.getElementById('image').click()">
                    ...
                    <p class="text-sm text-white/60">Upload category image</p>
                </div>
